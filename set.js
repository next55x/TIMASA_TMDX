...
module.exports = { session: process.env.SESSION_ID || 'ezra',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/next55x/TIMASA_TMDX',
    ...
    URL: process.env.URL || "https://files.catbox.moe/bq7ym6.jpg",  
    ...
    AUTO_STATUS_TEXT: process.env.AUTO_STATUS_TEXT || 'viewed by 𝚃𝙸𝙼𝙽𝙰𝚂𝙰',   
